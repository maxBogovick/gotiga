...
<div class="h-full flex flex-col">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-xl font-gothic text-[#d4c5b0]">{$t('adminReleaseHeading')}</h2>
            <p class="text-[10px] text-[#8a7f70] uppercase tracking-wider mt-1">Version management</p>
        </div>
        <div class="flex gap-4 items-center">
            ...
            {:else}
                <span class="text-[10px] text-[#8a7f70] italic">Upload a .db file via the button below</span>
    ...
    <div class="flex-1 bg-[#141210]/50 border border-[#d4c5b0]/10 overflow-hidden flex flex-col">
        ...
        <div class="overflow-y-auto flex-1 p-2 space-y-1">
            {#if isLoading}
                <div class="p-4 text-center text-[#8a7f70] text-xs animate-pulse">{$t('adminLoading')}</div>
    ...
    <div class="mt-4 p-4 border border-[#d4c5b0]/10 bg-[#141210]/30 text-xs text-[#8a7f70]">
        <h4 class="font-bold mb-2 uppercase tracking-widest text-[#d4c5b0]">Curator's Guide</h4>
        <ul class="list-disc pl-4 space-y-1">
            <li><strong class="text-[#d4c5b0]">Create release:</strong> {$t('adminReleaseInfoCreate')}</li>
            <li><strong class="text-[#d4c5b0]">Download active:</strong> {$t('adminReleaseInfoDownload')}</li>
        </ul>
    </div>
</div>
